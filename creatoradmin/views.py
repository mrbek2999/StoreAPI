...
from home.serializers import CategorySerializer, FAQSerializer
from .serializers import CustomerSerializer, CreatorSerializer, ProductsSerializer, OrderProductSerializer, CommentSerializer
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if current_user.user_type == CustomUser.Customer:
                ...
                return Response(data={"message": 'Your account has been created'})
        else:
            return Response(data={"message": "Registration error!"})
...
#################################################################################################################
## ADMIN PAGE
class StartapperHomeView(APIView):
    permission_classes = [IsAuthenticated]
    ...
    def get(self, request):
        try:
            ...
            return Response(data={"message": 'You go to developer page!'})
